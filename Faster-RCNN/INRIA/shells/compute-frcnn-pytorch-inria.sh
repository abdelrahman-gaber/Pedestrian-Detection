...
save_path=/data/stars/user/aabubakr/pd_datasets/outputs/INRIA/frcnn-pytorch-new/Test
...
do
    ...
    mkdir -p $save_folder
    python /home/aabubakr/detection-pytorch/faster_rcnn_pytorch/person-detection.py --source $source_folder --save $save_folder --thresh 0.0 

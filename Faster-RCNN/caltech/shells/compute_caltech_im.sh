...
save_path=/data/stars/user/aabubakr/pd_datasets/outputs/caltech/out-skip30-im
...
do
    ...
    mkdir -p $save_folder
    python /data/stars/share/py-faster-rcnn/tools/pd_code_saveimages.py --source $source_folder --save $save_folder --thresh 0.0 

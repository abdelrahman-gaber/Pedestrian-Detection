...
dataset_path=/data/stars/user/aabubakr/pd_datasets/datasets/caltech/annot-images-noskip/images/set00
save_path=/data/stars/user/aabubakr/pd_datasets/outputs/caltech/out-skip1-set00

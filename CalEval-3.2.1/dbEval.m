...
algs = algs(2);           % select one or more algorithms for evaluation
...
for p=1:nPlots
  ...
  if( plotAlg )
    ...
    kp=[find(strcmp(stra,'SSD')) find(strcmp(stra,'Faster-RCNN')) find(strcmp(stra,'SSD-ft-cal'))  1 1];

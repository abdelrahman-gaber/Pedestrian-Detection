...
save_path=/home/aabubakr/data/Misc/SSD/SSD001
...
do
    ...
    mkdir -p $save_folder
   /home/aabubakr/ssd-new/build/examples/ssd/ssd_detect /data/stars/share/abdel-internship/caffe/models/VGGNet/VOC0712Plus/SSD_512x512_ft/deploy.prototxt /data/stars/share/abdel-internship/caffe/models/VGGNet/VOC0712Plus/SSD_512x512_ft/VGG_VOC0712Plus_SSD_512x512_ft_iter_160000.caffemodel $source_folder/images_list.txt --confidence_threshold 0.01 --out_file $save_folder/detections-preprocessed.txt

    #/home/aabubakr/ssd-new/build/examples/ssd/ssd_detect /home/aabubakr/ssd-new/models/VGGNet/VOC0712Plus/deploy.prototxt /home/aabubakr/ssd-new/models/VGGNet/VOC0712Plus/VGG_VOC0712Plus_SSD_512x512_ft_iter_8797_cal.caffemodel $source_folder/images_list.txt --confidence_threshold 0.6 --out_file $save_folder/detections-preprocessed.txt

    python parse-detection-files/parse-image-list-csv.py -DetectionResultsPath $save_folder

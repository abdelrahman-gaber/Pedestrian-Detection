...
dataset_path=/data/stars/user/aabubakr/pd_datasets/datasets/ETHZ/SSD-ft-data/annotations-train
save_path=/home/aabubakr/data/ETHZ/annotations-train
...
do
    ...
    mkdir -p $save_folder
    python generate_annotations_finetuning_notCal.py -AnnotPath $source_folder -OutPath $save_folder

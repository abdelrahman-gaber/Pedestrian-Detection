...
save_path=/data/stars/user/aabubakr/pd_datasets/outputs/SSD-OUT/TUD-Brussels/SSD-ft-cal-fc-40000
...
do
   ...
   cp -a $save_path /home/aabubakr/codes/pedestrian-detection-evaluation/CalEval-3.2.1/data-TudBrussels/res/

...
dataset_path=/data/stars/user/aabubakr/pd_datasets/datasets/ETHZ/CalEval/images
save_path=/data/stars/user/aabubakr/pd_datasets/outputs/SSD-OUT/ETHZ/CalEval-ft_cal

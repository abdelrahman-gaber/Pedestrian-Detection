...
save_path=/data/stars/user/aabubakr/pd_datasets/outputs/SSD-OUT/INRIA/ft-inria
...
cp -a $save_path /home/aabubakr/codes/pedestrian-detection-evaluation/CalEval-3.2.1/data-INRIA/res/SSD-ft-inria 
